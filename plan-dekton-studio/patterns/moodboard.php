...
<section class="moodboard pds-section section-band" id="ambiances" aria-labelledby="mood-title" data-moodboard>
    ...
    <div class="mood-layout reveal">
        <div class="mood-image">
            <picture><source srcset="/wp-content/themes/plan-dekton-studio/assets/img/ambiance-obsidian.webp" type="image/webp"><img src="/wp-content/themes/plan-dekton-studio/assets/img/ambiance-obsidian.jpg" alt="Moodboard Obsidian Luxury" width="1536" height="1024" data-mood-image="" loading="lazy" decoding="async"></picture>        </div>
